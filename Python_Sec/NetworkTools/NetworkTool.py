...
def usage ():
    print "NetworkTool"
    print
    print "Usage: NetworkTool.py -t target_host -p port"
    ...
    print
    print "Examples: "
    print ".py -t 192.168.0.1 -p 5555 -l -c"
    print "NetworkTool.py -t 192.168.0.1 -p 5555 -l -u=C:\\target.exe"
    print "NetworkTool.py -t 192.168.0.1 -p 5555 -l -e=\"cat /etc/passwd\""
    print "echo 'ABCDEFGHI' | ./NetworkTool.py -t 192.168.11.12 -p 135"
    sys.exit(0)
